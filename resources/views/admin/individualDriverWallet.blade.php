...
@section('admincontent')
    <div class="bg-gray-800 my-10 p-6 rounded-xl">
        <h1 class="text-3xl font-bold mb-10">Driver Wallet Update</h1>
        ...
        <div class=" grid grid-cols-1 lg:grid-cols-2">
            <div>
                ...
                <a href="{{ route('driverwallet') }}" class="text-blue-500">--- Return to Driver Wallet table---</a>
                ...
                <h2 class="font-semibold">Driver details</h2>
                @foreach ($driverWalletDetails as $IndDriverDetails)
                    <table class="border border-gray-200 mt-3">
                        <tr class="border-b border-gray-200">
                            <td class="p-2">Customer Name</td>
                            <td class="p-2 border-l border-gray-200">{{ $IndDriverDetails->name }}</td>
                        </tr>
                        <tr class="border-b border-gray-200">
                            <td class="p-2">Customer Id</td>
                            <td class="p-2 border-l border-gray-200">{{ $IndDriverDetails->driverId }}</td>
                        </tr>
                        <tr class="border-b border-gray-200">
                            <td class="p-2">Customer wallet Id</td>
                            <td class="p-2 border-l border-gray-200">{{ $IndDriverDetails->wallet_id }}</td>
                        </tr>
                        <tr class="border-b border-gray-200">
                            <td class="p-2">Current Balance</td>
                            <td class="p-2 border-l border-gray-200">Rs. {{ $IndDriverDetails->balance }}/-</td>
                        </tr>
                    </table>
                @endforeach
            </div>

            <form action="{{ route('IndividualDriverWallet', $IndDriverDetails->wallet_id) }}"
        ...
        <div class="mt-10 pt-10 border-t border-gray-500">
            ...
            @if (count($driverTransDetails) > 0)
                <table class="w-full text-center text-gray-300 table-auto text-sm md:text-md">
                    ...
                    @foreach ($driverTransDetails as $transDetails)
