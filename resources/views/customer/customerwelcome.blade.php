    ...
    @if (Auth::guard('customer')->check())
        <nav class="bg-white border-gray-200 dark:bg-gray-900 dark:border-gray-700">
            <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                <a href="{{ route('customerdashboard') }}" class="flex items-center space-x-3 rtl:space-x-reverse">

                    <span
                        class="self-center text-2xl font-bold whitespace-nowrap dark:text-white">Customer-Dashboard</span>
                </a>
                    ...
                    <ul
                        ...
                        <li>
                            <button id="dropdownNavbarLink" data-dropdown-toggle="dropdownNavbar"
                                ...
                                @else
                                    <img src="{{ asset('uploads/' . Auth::guard('customer')->user()->profile_pic) }}"
                                ...
                                <ul class="py-2 text-sm text-gray-700 dark:text-gray-400"
                                    ...
                                    <li>
                                        <p
                                            ...
                                            <strong class="text-lg">{{ Auth::guard('customer')->user()->name }}</strong>
                                            <br>
                                            #{{ Auth::guard('customer')->user()->custId }}<br>
                                            #{{ Auth::guard('customer')->user()->wallet->wallet_id }}
                                        </p>
                                    </li>
